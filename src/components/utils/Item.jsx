...
text, img, btn, rating, price }) => {
  return (
    <>
        <div className={`
        relative bg-gradient-to-b ${color} ${shadow} grid items-center 
        ${ifExists ? 'justify-items-start':'justify-items-center'} 
        rounded-xl py-4 px-5 transition-all duration-700 
        ...
        `}>
            ...
            `}>
                ...
                <p className='text-slate-200 filter drop-shadow text-base md:text-small font-normal'>{text}</p>
                ...
                <div className='flex items-center justify-between w-28 my-2'>
                    ...
                    <div className='flex items-center gap-1'>
                        ...
                        <h1 className='font-normal md:text-small text-slate-100'>
                            {rating}
                        </h1>
                    </div>
                </div>
