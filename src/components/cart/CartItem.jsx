    ...
    <>
      <div className="flex items-center justify-between w-full px-5">
        <div className="flex items-center gap-5">
          <div className={`bg-gradient-to-b ${color} ${shadow} relative rounded p-3 hover:scale-105 duration-75 ease-in-out grid items-center`}>
        ...
        <div className="grid items-center gap-5 ">
          ...
          <div className="grid items-center justify-center">
            <button onClick={onRemoveItem} className="cursor-pointer bg-theme-cart rounded p-1.5 lg:p-0.5 items-center justify-center active:scale-95" type="button">
              <TrashIcon className="w-5 h-5 text-slate-100" />
            </button>
          </div>
        </div>
      </div>
